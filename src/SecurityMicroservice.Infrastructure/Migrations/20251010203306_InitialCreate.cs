        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Permissions_Options_OptionId",
                        column: x => x.OptionId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Audits_Entity_Timestamp",
                table: "Audits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Options_ModuleId_Route_HttpMethod",
                table: "Options",
                columns: new[] { "ModuleId", "Route", "HttpMethod" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_OptionId",
                table: "Permissions",
                column: "OptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Permissions_RoleId_OptionId_ActionCode",
                table: "Permissions",
                columns: new[] { "RoleId", "OptionId", "ActionCode" },
                unique: true);
